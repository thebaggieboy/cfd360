...
class InvestmentSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        ...
        fields = ['id', 'email', 'amount', 'investment_plan', 'status', 'investment_duration', 'investment_date', 'current_value', 'average_return', 'daily_roi', 'weekly_roi', 'monthly_roi', 'weekly_roi_date', 'monthly_roi_date']
