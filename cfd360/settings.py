...
DATABASES = {
       'default': dj_database_url.config(default='postgres://postgresql://avantrades_7tc9_user:SDYwzZAWhHtp5taMgID1hXJghoBoSnya@dpg-d08u3c3uibrs73cnalhg-a.oregon-postgres.render.com/avantrades_7tc9')
}
